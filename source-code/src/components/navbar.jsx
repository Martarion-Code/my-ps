...
export default function NavBar({ children }) {
  return (
    <>
      <header
        id="main-header"
        className="text-black fixed w-full top-0 z-50 transition-all duration-300 bg-white shadow-md"
      >
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between py-4">
            ...
            <nav
              id="main-nav"
              className="fixed inset-y-0 right-0 transform translate-x-full md:relative md:translate-x-0 bg-white md:bg-transparent w-64 md:w-auto h-full md:h-auto overflow-y-auto md:overflow-visible transition-transform duration-300 ease-in-out md:transition-none"
            >
